...
// type Wallet struct {
// 	Accounts map[string]*wallet2.Account
// }

// func LoadWallet(nodeID string) (*Wallet, error) {
// 	wallets := Wallet{}
// 	wallets.Accounts = make(map[string]*wallet2.Account)
...
// func (ws Wallet) GetAccount(address string) wallet2.Account {
...
// func (w *wallet2.Account) GobEncode() ([]byte, error) {
// 	privKey := &PrivKey{
// 		D:          w.PrivateKey.D,
